...
${OBJECTDIR}/CNNLSTMPredictionModel.o: CNNLSTMPredictionModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -ICNNet/Eigen -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNNLSTMPredictionModel.o CNNLSTMPredictionModel.cpp
...
${OBJECTDIR}/DTW.o: DTW.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -ICNNet/Eigen -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DTW.o DTW.cpp
