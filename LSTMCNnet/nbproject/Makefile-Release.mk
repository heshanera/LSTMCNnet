...
${OBJECTDIR}/CNNet/Activation.o: CNNet/Activation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNNet/Activation.o CNNet/Activation.cpp

${OBJECTDIR}/CNNet/CNN.o: CNNet/CNN.cpp
	${MKDIR} -p ${OBJECTDIR}/CNNet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNNet/CNN.o CNNet/CNN.cpp

${OBJECTDIR}/CNNet/ConvolutionLayer.o: CNNet/ConvolutionLayer.cpp
	${MKDIR} -p ${OBJECTDIR}/CNNet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNNet/ConvolutionLayer.o CNNet/ConvolutionLayer.cpp

${OBJECTDIR}/CNNet/FCLayer.o: CNNet/FCLayer.cpp
	${MKDIR} -p ${OBJECTDIR}/CNNet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNNet/FCLayer.o CNNet/FCLayer.cpp
...
${OBJECTDIR}/DTW.o: DTW.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DTW.o DTW.cpp

${OBJECTDIR}/LSTMCNNFCPredictionModel.o: LSTMCNNFCPredictionModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LSTMCNNFCPredictionModel.o LSTMCNNFCPredictionModel.cpp

${OBJECTDIR}/LSTMCNNPredictionModel.o: LSTMCNNPredictionModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LSTMCNNPredictionModel.o LSTMCNNPredictionModel.cpp
...
${OBJECTDIR}/LSTMnet/DataProcessor.o: LSTMnet/DataProcessor.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LSTMnet/DataProcessor.o LSTMnet/DataProcessor.cpp

${OBJECTDIR}/LSTMnet/FileProcessor.o: LSTMnet/FileProcessor.cpp
	${MKDIR} -p ${OBJECTDIR}/LSTMnet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LSTMnet/FileProcessor.o LSTMnet/FileProcessor.cpp
